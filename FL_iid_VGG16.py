...
import sys
import pandas as pd
from FL_utils_iid_VGG16 import log_memory_and_time, MemoryUsageCallback, save_model_and_history, create_model, get_data_for_round, train_model, generate_validation_images, add_validation_images_for_round, move_images
...
nom = "8_1_brightness_epochs_2_reload60_weighted"
Model = "VGG16"
...
for round_number in range(start_round, end_round):
    ...
    #epsilon = compute_dp_sgd_privacy.compute_epsilon(total_steps, noise_multiplier, delta)
